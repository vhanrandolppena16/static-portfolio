...
const Skills = () => {
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 py-10 w-full justify-center items-stretch">
    ...
    >
      ...
      <div className="sticky top-0 z-10 bg-gray-900 backdrop-blur-md center center">
          <div className="flex justify-center py-4">
            <h3 className="flex items-center gap-2 px-10 cursor-pointer
      ...
      <div className="px-6 py-6 space-y-6 items-center">
        {category.categories?.map((sub) => (
          <div key={sub.name}>
            <h4 className="text-lg sm:text-xl font-medium text-gray-500 mb-3 pl-4">
              {sub.name}
            </h4>
